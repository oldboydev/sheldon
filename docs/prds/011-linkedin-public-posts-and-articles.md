...
3. O manifesto social declara `network: true`, `cookies: false` e mídia. O efeito OCR pertence ao
   derivador local (`source.image`), executado somente pela fronteira de derivação do host, nunca
