# Sheldon — Documentação de Planejamento

## Produto

- [Visão](product/vision.md)
- [Arquitetura](product/architecture.md)
...
1. [Fundação e vault central](prds/001-foundation-and-vault.md)
2. [Plataforma de plugins](prds/002-plugin-platform.md)
3. [Plugins oficiais de ingestão](prds/003-core-ingestion-plugins.md)
4. [Runtime de agentes e revisão](prds/004-agent-runtime-and-review.md)
5. [Compilação e qualidade da wiki](prds/005-wiki-compilation-and-quality.md)
6. [Busca, consulta e write-back](prds/006-search-query-and-writeback.md)
7. [Integração com agentes: MCP e skill Sheldon](prds/007-agent-integration-mcp-and-skill.md)
