...
Cada resposta fica em `outputs/answers/<answer-id>/answer.json` dentro da entidade e registra pergunta, agente, conceitos e raws citados, timestamp e texto final. O comando não altera `wiki/`.
