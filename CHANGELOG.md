...
- A projeção limitada de relações aplica o teto antes de materializar a saída, sem penalizar travessias ilimitadas; links Markdown preservam prosa de listas e destinos com casing diferente no Windows, e a recuperação do índice corrompido remove artefatos auxiliares com diagnóstico acionável.
